package com.example.doctorprescriptioncustomer.fragments
...
import com.example.doctorprescriptioncustomer.Constants
import com.example.doctorprescriptioncustomer.R
import com.example.doctorprescriptioncustomer.activities.MainActivity
import com.example.doctorprescriptioncustomer.adapters.SpecializationAdapter
...
import com.example.doctorprescriptioncustomer.databinding.FragmentSpecializationBinding
        ...
        categoriesAdapter= SpecializationAdapter(requireContext(),categoriesList,object : ClickInterface {
            override fun onClick(
                ...
                when (clickType) {
                    ...
                    ClickType.ViewClick->{
                        mainActivity.navController.navigate(R.id.doctorListFragment, bundleOf(
                            Constants.specializationId to categoriesList[position].categoryId ))
